...
from .views import CoursViewSet, StudentViewSet, ProfessorViewSet, DepartmentViewSet
...
urlpatterns = [
    ...
    path('dep/', DepartmentViewSet.as_view({'get': 'list', 'post': 'create'}), name='name_list'),
    path('dep/<int:pk>/', DepartmentViewSet.as_view({'get': 'retrieve', 'put': 'update', 'delete': 'destroy'}), name='name_detail'),
